...
{    
    ...
    */
    ...
    [
        ...
        "Mise à jour des touches de clavier",
        "Inspection des caves",
        "Traitement des cultures de coca",
        "Indexation du rapport 05_complot-président_05406XD3.txt",
        "Nettoyage des vitres de la voiture à Polo",
        "Envoi de la cargaison d'armes vers Los Santos",
        "Rappel de l'agent Trevor au secteur B-04-D6",
        "Mise à jour des données non sécurisées",
        "Ce message est faux, écoutez Michael, il dit la vérité",
        "Michael n'existe pas, c'est une imagination de votre cerveau",
    ],
